...
class NavItem extends Component {
  render() {
    ...
    if (this.props.item.external) {
      ...
      subContent = (
        <NavLink onClick={() => this.props.navUpdateText(itemTitle)} to={this.props.item.url} className={this.props.LiClassA ? this.props.LiClassA : null} exact={true} target={itemTarget}>
          <NavIcon items={this.props.item} />
          {itemTitle}
          <NavBadge layout={this.props.layout} items={this.props.item} />
        </NavLink>
