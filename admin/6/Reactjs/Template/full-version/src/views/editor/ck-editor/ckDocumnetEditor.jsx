...
class CkDocumentEditor extends Component {
  render() {
    const html = `<h2 style="text-align:center;">The Flavorful Tuscany Meetup</h2>
              ...
              <div className="document-editor">
                ...
                <div className="document-editor__editable-container">
                  <div className="document-editor__editable">
                    <CkEditor html={html} editor="document" />
                  </div>
                </div>
              </div>
            </CardBody>
