...
@Component({
  selector: 'app-real1-chart',
  template: '<div id="real1-chart" style="height: 20px; width: 100%"></div>'
})
export class Real1ChartComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  ngAfterViewInit() {
    this.zone.runOutsideAngular(() => {
      ...
      const chart = am4core.create('real1-chart', am4charts.XYChart);
