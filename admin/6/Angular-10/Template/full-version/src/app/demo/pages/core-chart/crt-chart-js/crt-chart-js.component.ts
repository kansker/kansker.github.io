...
export class CrtChartJsComponent implements OnInit {
  ...
  ngOnInit() {
    setTimeout(() => {
      ...
      abc.addColorStop(0, '#2196f3');
      abc.addColorStop(1, '#2196f3');
      const def = (this.barBasicChartTag).createLinearGradient(0, 300, 0, 0);
      def.addColorStop(0, '#7759de');
      def.addColorStop(1, '#7759de');
      ...
      klm.addColorStop(0, '#7759de');
      klm.addColorStop(1, '#7759de');
      const hij = (this.lineIPMChartTag).createLinearGradient(0, 0, 500, 0);
      hij.addColorStop(0, '#2196f3');
      hij.addColorStop(1, '#2196f3');
      ...
      bcd.addColorStop(0, '#2196f3');
      bcd.addColorStop(1, '#2196f3');
      const efg = (this.areaBasicChartTag).createLinearGradient(0, 0, 500, 0);
      efg.addColorStop(0, '#4caf50');
      efg.addColorStop(1, '#4caf50');
      ...
      bcde.addColorStop(0, '#2196f3');
      bcde.addColorStop(1, '#2196f3');
      ...
      pqr.addColorStop(0, '#2196f3');
      pqr.addColorStop(1, '#2196f3');
      ...
      xyz.addColorStop(0, '#2196f3');
      xyz.addColorStop(1, '#2196f3');
