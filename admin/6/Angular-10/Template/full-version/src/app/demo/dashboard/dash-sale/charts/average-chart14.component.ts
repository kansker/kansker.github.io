...
@Component({
  selector: 'app-average-chart14',
  template: '<div id="average-chart14" class="position-absolute bottom-chart" style="height: 145px; width: 100%;"></div>'
})
export class AverageChart14Component implements OnInit, AfterViewInit, OnDestroy {
  ...
  ngAfterViewInit() {
    this.zone.runOutsideAngular(() => {
      ...
      const chart = am4core.create('average-chart14', am4charts.XYChart);
