...
@Component({
  selector: 'app-traffic-sale-chart',
  template: '<div id="traffic-sale-chart" style="height: 300px"></div>'
})
export class TrafficSaleChartComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  ngAfterViewInit() {
    this.zone.runOutsideAngular(() => {
      ...
      const chart = am4core.create('traffic-sale-chart', am4charts.XYChart);
