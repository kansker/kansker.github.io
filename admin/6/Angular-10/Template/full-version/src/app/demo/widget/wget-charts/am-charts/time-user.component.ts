...
@Component({
  ...
  template: '<div id="time-user" style="height: 470px"></div>'
})
export class TimeUserComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  ngAfterViewInit() {
    this.zone.runOutsideAngular(() => {
      ...
      const chart = am4core.create('time-user', am4charts.XYChart);
