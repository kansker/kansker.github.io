...
@Component({
  selector: 'app-average-chart12',
  template: '<div id="average-chart12" class="position-absolute bottom-chart" style="height: 145px; width: 100%"></div>'
})
export class AverageChart12Component implements OnInit, AfterViewInit, OnDestroy {
  ...
  ngAfterViewInit() {
    this.zone.runOutsideAngular(() => {
      ...
      const chart = am4core.create('average-chart12', am4charts.XYChart);
