...
@Component({
  ...
  template: '<div id="conversions-chart" style="height: 62px"></div>'
})
export class ConversionsChartComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  ngAfterViewInit() {
    this.zone.runOutsideAngular(() => {
      ...
      const chart = am4core.create('conversions-chart', am4charts.XYChart);
