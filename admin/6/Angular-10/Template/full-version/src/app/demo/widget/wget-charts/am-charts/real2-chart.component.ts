...
@Component({
  selector: 'app-real2-chart',
  template: '<div id="real2-chart" style="height: 20px; width: 100%"></div>'
})
export class Real2ChartComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  ngAfterViewInit() {
    this.zone.runOutsideAngular(() => {
      ...
      const chart = am4core.create('real2-chart', am4charts.XYChart);
