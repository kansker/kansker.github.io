...
@Component({
  selector: 'app-real4-chart',
  template: '<div id="real4-chart" style="height: 20px; width: 100%"></div>'
})
export class Real4ChartComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  ngAfterViewInit() {
    this.zone.runOutsideAngular(() => {
      ...
      const chart = am4core.create('real4-chart', am4charts.XYChart);
